...
//Objective : Adaptive Radix Tree for replace hash map
//TODO: testing
//TODO: Implement vectorization if possible
//Node128 , Node256 should be implemented with vectorization if possible
